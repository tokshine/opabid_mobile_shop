    ...
    public class NavigationService : INavigationService
    {
        ...
        protected virtual async Task InternalNavigateToAsync(Type viewModelType, object parameter)
        {
            ...
            else if (CurrentApplication.MainPage is MainView)
            {
                ...
                if (mainPage.Detail is ProductNavigationPage navigationPage)
                {
                ...
                {
                    navigationPage = new ProductNavigationPage(page);
            ...
            {
                var navigationPage = CurrentApplication.MainPage as ProductNavigationPage;
                ...
                {
                    CurrentApplication.MainPage = new ProductNavigationPage(page);
                }
            }

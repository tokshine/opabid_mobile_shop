...
namespace Shivonet.MobileShop.Core.ViewModels
{
    ...
    public class CartPageViewModel : BaseViewModel
    {
        ...
        private ObservableCollection<Product1> cartDetails;
        ...
        private ObservableCollection<Product1> produts;
        ...
        /// </summary>
        public ObservableCollection<Product1> CartDetails
        {
            get
            {
        ...
        public ObservableCollection<Product1> Products
        {
            get
            {
                return this.produts;
        ...
        private void GetProducts(ObservableCollection<Product1> Products)
        {
            this.CartDetails = new ObservableCollection<Product1>();
